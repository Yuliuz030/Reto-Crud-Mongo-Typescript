...
exports.connectToDatabase = exports.collection = void 0;
...
function connectToDatabase() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        exports.collection.comments = commentsCollection;
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield db.command({
            ...
            if (error.codeName === 'NamespaceNotFound') {
                yield db.createCollection(process.env.COMMENTS_COLLECTION_NAME, { validator: jsonSchema });
            }
        }));
    });
}
